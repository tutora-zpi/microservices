...
from app.schemas.events import NotificationEvent, ResourcesGeneratedData, ProcessingStatus
...
class NotificationPublisher:
    def __init__(self):
        ...
        logger.info(f"NotificationPublisher zainicjalizowany (Exchange: {self.exchange_name})")

    def publish_resources_generated(self, class_id: str, meeting_id: str, status: ProcessingStatus.SUCCESS):
        try:
            ...
            logger.error(f"Nie udało się wysłać powiadomienia do RabbitMQ: {e}", exc_info=True)
